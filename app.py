...
# Create variable for each classes so that we can reference them later
...
# Define Flask app
app = Flask(__name__)
# # example of the __name__ variable.  This is a special type of variable in Python. 
...
# Create min, avg, max temperatures route
